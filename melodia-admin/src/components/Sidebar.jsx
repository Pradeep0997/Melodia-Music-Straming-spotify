...
const Sidebar = () => {
  return (
    <div className='bg-[#0e2744] min-h-screen pl-[4vw]'>
        <img src={assets.melodia_logo} className='mt-5 w-[max(10vw,80px)] hidden sm:block' alt="" />
        <img src={assets.melodia_small_logo} className='mt-5 w-[max(5vw,50px)]  mr-5  sm:hidden block' alt="" />
